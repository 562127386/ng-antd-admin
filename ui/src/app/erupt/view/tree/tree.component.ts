...
import { colRules } from "@app/shared/zero-code/model/util.model";
...
export class TreeComponent implements OnInit, OnDestroy {
    ...
    del() {
        ...
        if (nzTreeNode.isLeaf) {
            this.modal.confirm({
                ...
                nzOnOk: () => {
                    this.behavior = Scene.ADD;
                    this.dataService.deleteEruptDataList(this.eruptBuildModel.eruptModel.eruptName, nzTreeNode.origin.key)
                        .subscribe(res => {
    ...
    fetchTreeData() {
        ...
        this.dataService.queryEruptTableData(this.eruptName).subscribe(tree => {
